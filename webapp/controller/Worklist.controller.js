    ...
    return BaseController.extend("grcriskassess.controller.Worklist", {
        ...
        onAfterRendering: function () {
            if(this.getModel("appConfigModel").getData().app === "ApproveApp") {
                this.fragment = sap.ui.xmlfragment("grcriskassess.view.fragments.RiskAssessmentApprover", this);
            } else {
                this.fragment = sap.ui.xmlfragment("grcriskassess.view.fragments.RiskAssessment", this);
            }
            this.byId("idCollaborativeRiskAssessPage").addContent(this.fragment);
            sap.ui.getCore().byId("collaborativeRiskAssessmentWizard").goToStep(this.byId("basicPlanDetails"), this);
        },
        ...
        handleSubmitRiskAssess: function () {
            sap.m.MessageBox.success("Collaborative Risk Plan has been submitted successfully");
            this.goToPrevPage();
        },

        handleApproveRiskAssess: function () {
            sap.m.MessageBox.success("Collaborative Risk Plan has been Approved  Successfully");
            this.goToPrevPage();
        },
